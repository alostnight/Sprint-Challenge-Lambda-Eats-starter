...
It allows for pages to be seperated and no confusion in the system on what to display.

2. How would you explain form validation to someone who has never programmed before?

It allows for testing certain parts of the application and make sure that they are working.

3. In 1-2 sentences, define end to end testing.

It makes sure everything is running right and that there are no errors.
